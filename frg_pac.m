        ...
        for cat_idx = 1:length(trial_categories)
            ...
            try
                ...
                try
                    ...
                    pac_dat = pop_loadset('filename',[fname '_FZ_CZ_theta_gamma.set'],...
                    ...
                    ep_dat = pop_pac(ep_dat,'Channels',[4 8],[30 90],...
                                    [fz_idx fz_idx cz_idx],[fz_idx cz_idx cz_idx],...
                                    'method','ermipac','nboot',200,'alpha',[],...
                                    'nfreqs1',10,'nfreqs2',20,'freqscale','log','bonfcorr',0);
                    ep_dat = pop_saveset(ep_dat,'filename',[fname ...
                                        '_FZ_CZ_theta_gamma.set'],...
